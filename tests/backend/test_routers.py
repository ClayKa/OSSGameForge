...
class TestProjectsRouter:
    ...
    @patch('app.config.settings.mock_mode', True)
    def test_list_projects_mock_mode(self):
        """Test listing projects in mock mode"""
        with patch('app.routers.projects.load_mock_data') as mock_load:
...
class TestAssetsRouter:
    ...
    def test_list_project_assets(self):
        ...
        with patch('app.routers.assets.load_mock_data') as mock_load:
            mock_load.return_value = {
                "assets": [
                    {
                        "id": "asset_001",
...
class TestGenerationRouter:
    ...
    def test_generate_scene(self):
        ...
        with patch('app.routers.generation.load_mock_data') as mock_load:
            mock_load.return_value = {
                "generation_samples": [
                    {
